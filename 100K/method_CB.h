...
int PartitionKNN(double * distances, int * indices, int low, int high) {
...
/* Computes the predicted score attributed by a user to a movie */
...
int IndexOfMovieRecom(int Movie_Id, MovieRecom TheMovieRecom[MaxNeighbours*MaxMovies], int NbMovieRecom){
	int k;
...
// Function of partitionnement for the QuickSortMovies by Importance
...
// QuickSort Movies by Importance
