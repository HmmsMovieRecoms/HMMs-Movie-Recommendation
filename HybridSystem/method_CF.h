...
int FrequencyOf_Occupations(User_CF TheUsers[MaxUsers], int NbUsers, char TheOccupations[MaxOccupations][50], int FreqOfThe_Occupations[MaxOccupations]){
...
int FrequencyOf_ZipCodeGroups(User_CF TheUsers[MaxUsers], int NbUsers, char FirstChar_ZipCodeGroup[MaxZipCodeGroups], int FreqOfThe_ZipCodeGroup[MaxZipCodeGroups]){
