// Forward algorithm
void Forward_CB(HMM Lambda, int O[MaxMovies], int t_bar, long double Alpha[MaxMovies][MaxStates]){
	int i, j, t;
...
// Backward algorithm
void Backward_CB(HMM Lambda, int O[MaxMovies], int t_bar, long double Beta[MaxMovies][MaxStates], int T){
	int i, j, t;
...
double Forward_Backward_CB(HMM Lambda, int O[MaxMovies], int t_bar, int T){
    int j;
    double Proba_Observ = 0.0;
	long double Alpha[MaxMovies][MaxStates], Beta[MaxMovies][MaxStates];
...
// Computes Xi
void CalculXi_CB(HMM Lambda, int O[MaxMovies], int T, long double Alpha[MaxMovies][MaxStates], long double Beta[MaxMovies][MaxStates], double Proba_Observ, long double Xi[MaxMovies][MaxStates][MaxStates]){
	int i, j, t;
...
// Computes Gamma
void CalculGamma_CB(HMM Lambda, int O[MaxMovies], int T, long double Alpha[MaxMovies][MaxStates], long double Beta[MaxMovies][MaxStates], double Proba_Observ, long double Gamma[MaxMovies][MaxStates]){
	int j, t;
...
int Baum_Welch_Mono_CB(HMM Lambda_Init, int O[MaxMovies], int T, double epsilon, int MaxIterations, HMM * Lambda){
    HMM Lambda_Old, Lambda_New;
   int i, j, t, t_bar,l, iterations;
	double Proba_Old, Proba_New;
	long double Alpha[MaxMovies][MaxStates],  Beta[MaxMovies][MaxStates], Alpha_bar[MaxMovies][MaxStates],  Beta_bar[MaxMovies][MaxStates], Gamma[MaxMovies][MaxStates],Xi[MaxMovies][MaxStates][MaxStates];
